...
const vendorUploadMAColumns = [
  ...
  },
  {
    ...
    render: ({ packaging_item }) => {
      return (
        <LibraryText>{packaging_item?.unit_of_measurement_label}</LibraryText>
      );
    },
  },
  {
...
export default vendorUploadMAColumns;
